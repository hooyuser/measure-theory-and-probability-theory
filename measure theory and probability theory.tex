...
\begin{theorem}[Carathéodory's extension theorem]
	...
	\begin{enumerate}[(1)]
		\item $\mathcal{C}\subset\mathcal{M}_{\mu^{*}_0}$, where $\mathcal{M}_{\mu^{*}_0}$ denotes the collection of all $\mu^{*}_0$-measurable subsets of $\Omega$,
		\item $\mu^{*}_0|_{\mathcal{C}}=\mu_0$,
		\item $(\Omega, \mathcal{M}_{\mu^{*}_0}, \mu^{*}|_{\mathcal{M}_{\mu^{*}_0}})$ is a complete measure space. $(\Omega, \sigma(\mathcal{C}), \mu^{*}|_{\sigma(\mathcal{C})})$ is a measure space.
		\item If $\mu_0$ is $\sigma$-finite then  $\mu^{*}_0|_{\sigma(\mathcal{C})}$ is the unique measure on $(\Omega, \sigma(\mathcal{C}))$ that coincides with $\mu_0$ on $\mathcal{C}$. In this case, $\mu^{*}_0|_{\sigma(\mathcal{C})}$ is also $\sigma$-finite.
	\end{enumerate}
\end{theorem}
